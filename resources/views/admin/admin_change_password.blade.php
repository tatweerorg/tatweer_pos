                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('update.password') }}">
                            ...
                            <div class="row mb-3 mt-3">
                                ...
                                <label for="example-text-input" class="col-sm-2 col-form-label">كلمة المرور القديمة</label>
                            ...
                            <input type="submit" class="btn btn-info waves-effect waves-light" value="تعديل">
