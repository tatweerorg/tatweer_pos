            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">صفحة تعديل المصاريف</h4><br>
                        ...
                        <form method="post" action="{{ route('expense.update', $expense->id) }}" id="myForm">
                            ...
                            <div class="row mb-3 mt-3">
                                ...
                                <div class="form-group col-sm-10">
                                    <input name="date" class="form-control" type="date" value="{{ $expense->date }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-3">
                                ...
                                <div class="form-group col-sm-10">
                                    <input name="amount" class="form-control" type="number" value="{{ $expense->amount }}">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3 mt-3">
                                ...
                                <div class="form-group col-sm-10">
                                    <textarea name="notes" class="form-control" id="example-textarea-input" rows="3">{{ $expense->notes }}</textarea>
                                </div>
                            </div>
                            <!-- end row -->

                            <input type="submit" class="btn btn-info waves-effect waves-light" value="تحديث المصروف">
